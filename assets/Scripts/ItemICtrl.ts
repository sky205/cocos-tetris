...
@ccclass('ItemICtrl')
export class ItemOCtrl extends ItemCtrl {
    // [1]
    // dummy = '';
    ...
    transform(index: number) {
        ...
        switch(this.oritation){
            case 1:
                this.curHeight = this.CUBE_SIZE * 1;
                this.curWidth = this.CUBE_SIZE * 4;
                this.childrenPos.push(new Vec3(120, 0, 0));
                this.childrenPos.push(new Vec3(80, 0, 0));
                this.childrenPos.push(new Vec3(40, 0, 0));
                this.childrenPos.push(new Vec3(0, 0, 0));
                break;
            case 0:
                this.curHeight = this.CUBE_SIZE * 4;
                this.curWidth = this.CUBE_SIZE * 1;
                this.childrenPos.push(new Vec3(0, 120, 0));
